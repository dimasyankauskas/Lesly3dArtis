...
Renders environment maps for reflections.

```javascript
const cubeRenderTarget = new THREE.WebGPCubeRenderTarget(256);
...
THREE.MathUtils.mapLinear(value, inMin, inMax, outOut, outMax);
